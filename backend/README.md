...
## Project Structure
    ...
    ├── world_housing_homda_35456  # Django project configurations
...
1. Clone this repo and `cd world_housing_homda_35456`
...
2. Clone this repo and `cd world_housing_homda_35456`
